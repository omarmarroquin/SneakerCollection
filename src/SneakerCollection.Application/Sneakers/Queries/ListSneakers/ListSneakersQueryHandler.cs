...
public class ListSneakersQueryHandler : IRequestHandler<ListSneakersQuery, ErrorOr<ListSneakersResult>>
{
  private readonly ISneakerRepository _sneakerRepository;
  private readonly IUserRepository _userRepository;

  public ListSneakersQueryHandler(ISneakerRepository sneakerRepository, IUserRepository userRepository)
  {
